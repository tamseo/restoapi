 ...
 * 
 * These tests utilize the Mockito framework objects to simulate interaction with back-end
 * components. The controller methods are invoked directly bypassing the Spring MVC mappings.
 * Back-end components are mocked and injected into the controller. Mockito spies and verifications
 * are performed ensuring controller behaviors.
 * 
 * @author Matt Warman
 */
@Transactional
