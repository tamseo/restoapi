...
import com.tamseo.ws.web.api.BaseController;

/**
 * This class extends the functionality of AbstractTest. AbstractControllerTest is the parent of all
 * web controller unit test classes. The class ensures that a type of WebApplicationContext is built
...
public abstract class AbstractControllerTest extends AbstractTest {
  ...
  /**
   * Prepares the test class for execution of web tests. Builds a MockMvc instance using standalone
   * configuration facilitating the injection of Mockito resources into the controller class.
   * 
   ...
   * @param clazz A Class of type T. The mapper will attempt to convert the JSON into an Object of
   *        this Class type.
