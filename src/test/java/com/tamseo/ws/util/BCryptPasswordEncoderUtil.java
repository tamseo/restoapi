...
/**
 * The BCryptPasswordEncoderUtil class assists engineers during application construction. It is not
 * intended for use in a 'live' application.
 * 
 * The class uses a BCryptPasswordEncoder to encrypt clear text values using it's native hashing
 * algorithm. This utility may be used to create encrypted password values in a database
 * initialization script used for unit testing or local machine development.
 * 
 * @author Matt Warman
 *
 */
