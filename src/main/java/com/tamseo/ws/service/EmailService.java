...
/**
 * The EmailService interface defines all public business behaviors for composing and transmitting
 * email messages.
 * 
...
public interface EmailService {
  ...
  /**
   * Send a Greeting via email asynchronously. Returns a Future&lt;Boolean&gt; response allowing the
   * client to obtain the status of the operation once it is completed.
   * 
   * @param greeting A Greeting to send.
