...
public class GreetingBatchBean {
  ...
  /**
   * Use a cron expression to execute logic on a schedule. Expression: second minute hour
  ...
  /**
   * Execute logic beginning at fixed intervals. Use the <code>fixedRate</code> element to indicate
   * how frequently the method is to be invoked.
   */
  @Scheduled(fixedRateString = "${batch.greeting.fixedrate}")
  public void fixedRateJob() {
    logger.info("> fixedRateJob");

    counterService.increment("method.invoked.greetingBatchBean.fixedRateJob");
   ...
   * <code>initialDelay</code> element to indicate how long to wait after application startup to
   ...
   * Use the <code>fixedDelay</code> element to indicate the time to wait between executions.
   */
  ...
  /**
   * Execute logic with a delay between the end of the last execution and the beginning of the next.
   * Use the <code>fixedDelay</code> element to indicate the time to wait between executions. Use
   * the <code>initialDelay</code> element to indicate how long to wait after application startup to
   * schedule the first execution.
   */
  @Scheduled(initialDelayString = "${batch.greeting.initialdelay}",
