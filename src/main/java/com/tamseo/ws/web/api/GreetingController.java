...
import com.tamseo.ws.service.EmailService;
import com.tamseo.ws.service.GreetingService;

/**
 * The GreetingController class is a RESTful web service controller. The
 * <code>@RestController</code> annotation informs Spring that each <code>@RequestMapping</code>
 * method returns a <code>@ResponseBody</code>.
 * 
 */
@RestController
public class GreetingController extends BaseController {
  ...
  /**
   * Web service endpoint to fetch all Greeting entities. The service returns the collection of
   * Greeting entities as JSON.
   * 
   ...
   * @return A ResponseEntity containing a single Greeting object, if found, and a HTTP status code
  ...
  /**
   * Web service endpoint to create a single Greeting entity. The HTTP request body is expected to
   * contain a Greeting object in JSON format. The Greeting is persisted in the data repository.
   * 
   ...
   * @return A ResponseEntity containing a single Greeting object, if created successfully, and a
  ...
  /**
   * Web service endpoint to update a single Greeting entity. The HTTP request body is expected to
   * contain a Greeting object in JSON format. The Greeting is updated in the data repository.
   * 
   ...
   * @return A ResponseEntity containing a single Greeting object, if updated successfully, and a
   *         HTTP status code as described in the method comment.
   * @throws Exception Thrown if a problem occurs completing the request.
   */
  ...
  /**
   * Web service endpoint to delete a single Greeting entity. The HTTP request body is empty. The
   * primary key identifier of the Greeting to be deleted is supplied in the URL as a path variable.
   * 
   ...
   * 
   * @param id A Long URL path variable containing the Greeting primary key identifier.
   * @return A ResponseEntity with an empty response body and a HTTP status code as described in the
   *         method comment.
  ...
  /**
   * Web service endpoint to fetch a single Greeting entity by primary key identifier and send it as
   * an email.
   * 
   ...
   * 
   * @param id A Long URL path variable containing the Greeting primary key identifier.
   * @param waitForAsyncResult A boolean indicating if the web service should wait for the
  ...
  @RequestMapping(value = "/api/greetings/{id}/send", method = RequestMethod.POST,
      produces = MediaType.APPLICATION_JSON_VALUE)
  public ResponseEntity<Greeting> sendGreeting(@PathVariable("id") Long id, @RequestParam(
